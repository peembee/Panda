  ...
  return (
    <Navbar className="navbar" display="flex" expand="md">
      <Container>
        ...
        <Navbar.Toggle aria-controls="basic-navbar-nav" className="dropdownIconBox">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="30" fill="currentColor" className="bi bi-list" viewBox="0 0 16 16">
